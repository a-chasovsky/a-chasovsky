...
Датасет Kaggle, в котором собраны данные о транзакциях по кредитным картам. Необходимо решить задачу классификации - выявить мошеннические операции. Время совершения транзакций задано как количество секунд с момента совершения первой транзакции. Чтобы повысить эффективность модели и ввести дополнительный бинарный признак (транзакция совершена днем/ночью), предложен алгоритм, определяющий время совершения первой транзакции.
